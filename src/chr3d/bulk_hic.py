...
class HiCMatrixGenerator:
    ...
    def create(self,
        ...
        return {'output_cool': output_cool, 'cool_size_bytes': cool_size, 'resolution': resolution}
...
class HiCPipeline:
    ...
    def align(self,
        ...
        # -M: Mark shorter split hits as secondary
        cmd = f"bwa mem -SP5M -t {self.threads} {self.genome_index} {fastq1} {fastq2} > {output_sam} 2> {stats_file}"
