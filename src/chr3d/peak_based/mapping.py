...
"""Genomic Mapping Module. Maps linker-filtered ChIA-PET tags to reference genome using BWA."""
...
class PETMapper:
    ...
    def __init__(
        ...
        logger.info(f"Initialized PETMapper")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Map ChIA-PET reads to reference genome"
    )
